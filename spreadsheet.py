...
HEADER_DATA = [
    ["Kode SA", "Nama Lengkap", "Nomor HP SA", "Witel", "Telkom Daerah", "Tanggal Visit", "Kategori Pelanggan", "Kegiatan", "Layanan Saat Ini",
     "Tarif Layanan Saat Ini", "Nama PIC Pelanggan", "Jabatan PIC", "Nomor HP PIC Pelanggan", "Jika Dealing, Paket Berapa Mbps",
     "Dealing Layanan Bundling", "Foto Evidence Visit"]
]
